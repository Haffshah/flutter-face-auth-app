...
import 'package:face_match/ui/utils/anim/custom_animation_controller.dart';
...
class FadeBoxTransition extends ConsumerStatefulWidget {
  ...
  const FadeBoxTransition({super.key, required this.child, this.onPopCall, this.delay});
