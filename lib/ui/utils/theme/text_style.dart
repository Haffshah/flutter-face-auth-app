...
class TextStyles {
  ...
  static TextStyle get thin =>
      TextStyle(color: AppColors.textMainFontByTheme(), fontSize: 16.sp, fontWeight: fwThin, fontFamily: fontFamily);
  ...
  static TextStyle get light =>
      TextStyle(color: AppColors.textMainFontByTheme(), fontSize: 16.sp, fontWeight: fwLight, fontFamily: fontFamily);

  static TextStyle get regular =>
      TextStyle(color: AppColors.textMainFontByTheme(), fontSize: 16.sp, fontWeight: fwRegular, fontFamily: fontFamily);

  static TextStyle get medium =>
      TextStyle(color: AppColors.textMainFontByTheme(), fontSize: 16.sp, fontWeight: fwMedium, fontFamily: fontFamily);
  ...
  static TextStyle get bold =>
      TextStyle(color: AppColors.textMainFontByTheme(), fontSize: 16.sp, fontWeight: fwBold, fontFamily: fontFamily);
