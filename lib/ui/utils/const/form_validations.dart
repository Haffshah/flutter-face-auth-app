...
String? validateText(String? value, String error, {int? minLength}) {
  if (value == null || value.trim().isEmpty || value.trim().length < (minLength ?? 3)) {
    return error;
  } else {
    return null;
  }
...
String? validateTextWithLength(String? value, String error, {int? minLength}) {
  if (value == null || value.trim().isEmpty || value.trim().length < (minLength ?? 3)) {
    return error;
  } else {
    return null;
...
String? validateMobile(String? value) {
  if (value == null || value == '') {
    return LocaleKeys.keyContactNumberValidation.localized;
      ...
      !(value.trim().length > minMobileLength) &&
      (value.trim().length < maxMobileLength)) {
...
String? validateEmail(String? value) {
  ...
  if (value == null || value.trim().isEmpty) {
    return LocaleKeys.keyEmailRequiredValidation.localized;
...
String? validateOtp(String? value) {
  if (value == null || value.trim().isEmpty || value.trim().length < otpLength) {
...
String? validateAmount(String? value, String errorMessage) {
  ...
  // if (amount == null) {
  //   return LocaleKeys.keyPleaseEnterAValidAmount.localized;
  // }

  // if (amount <= 0) {
  //   return LocaleKeys.keyAmountMustBeGreaterThan0.localized;
  // }
