...
mixin BaseStatefulWidget<Page extends StatefulWidget> on State<Page> {
  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout.builder(
      breakpoints: const ScreenBreakpoints(desktop: 1000, tablet: 852, watch: 100),
      mobile: (BuildContext context) {
        ScreenUtil.init(context, designSize: const Size(393, 852));
        return buildPage(context);
      },
      tablet: (BuildContext context) {
        ScreenUtil.init(context, designSize: const Size(852, 1366));
        return buildPage(context);
      },
      desktop: (BuildContext context) {
        ScreenUtil.init(context, designSize: const Size(1366, 852));
        return buildPage(context);
      },
    );
  }
