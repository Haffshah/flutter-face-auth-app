...
class _CommonButtonState extends State<CommonButton> with BaseStatefulWidget {
  ...
  Widget buildPage(BuildContext context) {
    Color buttonColor = widget.isButtonEnabled
        ...
        : (widget.buttonDisabledColor ?? AppColors.grey);
              ...
              : Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          if ((widget.leftIcon != null && widget.leftImage == null))
                          ...
                          CommonText(
                            ...
                            textStyle: widget.buttonTextStyle ??
                                TextStyles.semiBold.copyWith(
                                    fontSize: widget.buttonTextSize ?? 14.sp,
                                    color: widget.buttonTextColor ??
                                        (widget.isButtonEnabled ? AppColors.white : AppColors.black)),
                          ),
                          if ((widget.rightIcon != null && widget.rightImage == null))
