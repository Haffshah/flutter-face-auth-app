...
import 'package:face_match/ui/utils/widgets/cache_image.dart';
  ...
  Widget buildPage(BuildContext context) {
    return isFileImage == true
        ...
        : ClipRRect(
            ...
            child: Image.asset(strIcon, height: height, width: width, color: imgColor, fit: boxFit ?? BoxFit.scaleDown),
          );
  }
}
