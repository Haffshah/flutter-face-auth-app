import 'package:face_match/ui/routing/animation_transition/navigation_trasition_widget.dart';
import 'package:face_match/ui/routing/navigation_stack_keys.dart';
import 'package:face_match/ui/routing/stack.dart';
import 'package:face_match/ui/screens/splash/splash_screen.dart';
import 'package:face_match/ui/screens/user/user_registration_screen.dart';
import 'package:face_match/ui/screens/user/user_list_screen.dart';
import 'package:face_match/ui/screens/user/face_scan_screen.dart';
      ...
      .mapIndexed(
        (e, i) => e.when(
          splash: () => const MaterialPage(
            child: NavigationStackWidget(child: SplashScreen()),
            key: ValueKey(Keys.splash),
          ),
          userRegistration: (user) => MaterialPage(
            child: NavigationStackWidget(child: UserRegistrationScreen(user: user)),
            key: ValueKey(Keys.userRegistration),
          ),
          userList: () => const MaterialPage(
            child: NavigationStackWidget(child: UserListScreen()),
            key: ValueKey(Keys.userList),
          ),
          faceScan: () => const MaterialPage(
            child: NavigationStackWidget(child: FaceScanScreen()),
            key: ValueKey(Keys.faceScan),
          ),
        ),
      )
      .toList();
